...
{
    public const string AssemblyTitle = "Oyosoft.AgenceImmobiliere.UniversalAppWin10";
    public const string AssemblyDescription = "Client Windows 10 du service WCF permettant la gestion d'une agence immobilière.";
