...
{
    public const string AssemblyTitle = "Oyosoft.AgenceImmobiliere.WcfService";
    public const string AssemblyDescription = "Service WCF permettant la gestion d'une agence immobilière.";
    ...
    public const string AssemblyGuid = "17ae1fc4-76b0-42da-86d4-4f0fb941b4ab";
