...
[assembly: NeutralResourcesLanguage(AssemblyInfo.NeutralResourcesLanguage)]
...
{
    public const string AssemblyTitle = "Oyosoft.AgenceImmobiliere.Core";
    public const string AssemblyDescription = "Librairie de base permettant la gestion d'une agence immobilière.";
    ...
    public const string NeutralResourcesLanguage = "fr";
